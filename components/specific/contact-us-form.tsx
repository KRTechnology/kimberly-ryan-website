            ...
            <div className="w-full">
              {!showSuccessScreen ? (
                <>
                  ...
                  {/* Submit Status Message (only for errors) */}
                  <AnimatePresence>
                    {submitStatus === "error" && (
                      <motion.div
                ...
                >
                  ...
                  <p className="text-[#535862] text-lg mb-8 leading-relaxed">
                    {submitMessage}
                  </p>
                  <p className="text-[#535862] text-base mb-8 leading-relaxed">
                    We'll review your enquiry and get back to you within 24
                    hours.
                  </p>
                  <button
